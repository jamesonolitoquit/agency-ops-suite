...
-- ⚠️ Client-facing surface login (not part of the internal-only tool)
...
3. Client-facing surface: Not part of the internal-only tool; no additional validation required.
